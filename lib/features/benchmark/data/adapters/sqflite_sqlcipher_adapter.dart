...
class SqfliteSqlcipherAdapter implements DatabaseAdapter {
  sqlcipher.Database? _db;

  @override
  String get engineName => 'sqflite_sqlcipher';

  sqlcipher.Database get _database => _db!;
  ...
  Future<void> open({
    ...
    _db = await sqlcipher.openDatabase(
      dbPath,
      version: 1,
      password: password ?? 'benchmark_password',
    );
  ...
  @override
  Future<void> deleteDatabaseFile(String dbPath) => sqlcipher.deleteDatabase(dbPath);
